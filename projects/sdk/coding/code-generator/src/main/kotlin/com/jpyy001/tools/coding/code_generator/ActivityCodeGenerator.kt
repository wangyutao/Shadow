...
class ActivityCodeGenerator {
    ...
    companion object {
        const val ACTIVITY_CONTAINER_PACKAGE = "com.jpyy001.tools.core.runtime.container"
        const val RUNTIME_PACKAGE = "com.jpyy001.tools.core.runtime"
        const val DELEGATE_PACKAGE = "com.jpyy001.tools.core.loader.delegates"
        ...
        /**
         * 这个类集中解决一个问题的逻辑。问题Issue见https://github.com/jpyy001/tools/issues/230
         *
         * 问题描述：
         * 一般情况下，一个类的方法签名中如果含有找不到的类，在这个类本身被new出来时是不会出错的。
         * JVM不会去检查一个类的所有方法的签名中涉及到的类是否都存在。只有当调用该方法时才会发现签名上的类找不到。
         *
         * 但是在com.jpyy001.tools.core.loader.ShadowPluginLoader.getHostActivityDelegate中，
    ...
    val commonJavadoc =
        "由\n" + "{@link com.jpyy001.tools.coding.code_generator.ActivityCodeGenerator}\n" + "自动生成\n"
