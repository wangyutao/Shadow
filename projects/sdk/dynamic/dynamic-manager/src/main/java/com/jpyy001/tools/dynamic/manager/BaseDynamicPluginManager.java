...
import com.jpyy001.tools.core.manager.BasePluginManager;
...
abstract public class BaseDynamicPluginManager extends BasePluginManager implements UuidManagerImpl {
    ...
    public TargetPackage getPlugin(String uuid, String partKey) throws FailedException, NotFoundException {
        try {
    ...
    private TargetPackage getInstalledPL(String uuid, int type) throws FailedException, NotFoundException {
        try {
            InstalledPlugin.Part part;
            try {
            ...
            return new TargetPackage(part.pluginFile.getAbsolutePath(),
                    part.oDexDir == null ? null : part.oDexDir.getAbsolutePath(),
                    part.libraryDir == null ? null : part.libraryDir.getAbsolutePath());
        } catch (RuntimeException e) {
            throw new FailedException(e);
    ...
    public TargetPackage getPluginLoader(String uuid) throws FailedException, NotFoundException {
        return getInstalledPL(uuid, InstalledType.TYPE_PLUGIN_LOADER);
    }

    public TargetPackage getRuntime(String uuid) throws FailedException, NotFoundException {
